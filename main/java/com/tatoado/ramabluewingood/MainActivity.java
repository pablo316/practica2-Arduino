...
public class MainActivity extends Activity {
    ...
    Button btnOn, btnOff, btnArriba, btnAbajo, btnIzquierda, btnDerecha ;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final RelativeLayout controles = (RelativeLayout) findViewById(R.id.controles);
        final RelativeLayout menu = (RelativeLayout) findViewById(R.id.menu);
        ...
        btnArriba = (Button) findViewById(R.id.Arriba);
        btnAbajo = (Button) findViewById(R.id.Abajo);
                       ...
                       // txtStringLength.setText("Tamaño del String = " + String.valueOf(dataLength));
                        ...
                        if (recDataString.charAt(0) == '#')								//if it starts with # we know it is what we are looking for
                        {
                           // String sensor0 = recDataString.substring(1, 20);             //get sensor value from string between indices 1-5
                            //String sensor1 = recDataString.substring(14, 28);            //same again...
                            //String sensor2 = recDataString.substring(29, 44);
